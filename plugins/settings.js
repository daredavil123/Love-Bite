const { lovebite,mode } = require('../lib/');
const fs = require('fs');
...
izumi({
    ...
    const cap = "𝑳𝒐𝒗𝒆 𝑩𝒊𝒕𝒆\n\nRᴇᴘᴏ:https://github.com/daredavil123/Love-Bite\n\nSᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ:https://chat.whatsapp.com/JoyLnRV3KjgEcWeyZ3673D\n\nLɪᴠᴇ Uꜱᴇʀꜱ Cᴏᴜɴᴛ:https://users.maskser.me";
...
izumi({
    ...
    try {
        ...
        await client.sendMessage(message.jid, {
            ...
            contextInfo: { 
                externalAdReply: {
                    title: "𝑳𝒐𝒗𝒆 𝑩𝒊𝒕𝒆 Sᴜᴘᴘᴏʀᴛ🧚‍♂️",
                    body: "𝑴𝒓.  𝑫𝒂𝒔 ‹𝟹",
                    sourceUrl: "https://chat.whatsapp.com/JoyLnRV3KjgEcWeyZ3673D",
                    mediaUrl: "https://chat.whatsapp.com/JoyLnRV3KjgEcWeyZ3673D",
                    mediaType: 1,
                    showAdAttribution: true,
                    renderLargerThumbnail: false,
                    thumbnailUrl: "https://files.catbox.moe/havpx2.png"
                }
            }
        });
    } catch (error) {
